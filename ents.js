        ...
        await changeAgents.forEach(async(el, idx)=>{
          await setTimeout(async() => {
            ...
            await page1.waitForTimeout(5000);
                ...
                //scroll into view
                await page1.waitForTimeout(1000);
                await page1.waitForSelector(`#tab-content-78 > div > custom-entities-list > div > ul > li:nth-child(${ints.num}) > md-checkbox > div.md-container.md-ink-ripple`,{ timeout: 0 });
                await page1.waitForTimeout(2000);
                console.log(`selecting entity`)
                await page1.click(`#tab-content-78 > div > custom-entities-list > div > ul > li:nth-child(${ints.num}) > md-checkbox > div.md-container.md-ink-ripple`)
            await page1.waitForTimeout(1000);
              ...
              await page1.waitForTimeout(1000); 
                ...
                //select agent
              await page1.waitForSelector('#select_13854',{ timeout: 0 })
              console.log('selecting selct agent')
              await page1.waitForTimeout(1000);
              await page1.click('#select_13854')
