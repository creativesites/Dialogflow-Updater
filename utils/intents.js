            ...
            try {
             ...
             await ints.forEach(async(e, i)=>{
              setTimeout(async() => {
                  ...
                  //scroll into view
                  await page1.waitForTimeout(1000);
                  await page1.waitForSelector(`#main > div > div.workplace.ng-scope > div > div > div.ng-scope > ul > li:nth-child(${e[1]}) > intents-list-item > div > div > md-checkbox > div.md-container.md-ink-ripple`,{ timeout: 0 });
                  await page1.waitForTimeout(2000);
                  console.log('selecting intent')
                  await page1.click(`#main > div > div.workplace.ng-scope > div > div > div.ng-scope > ul > li:nth-child(${e[1]}) > intents-list-item > div > div > md-checkbox > div.md-container.md-ink-ripple`)
...
exports.intents = async (req, res, next) => {
    let agent = req.body.agent;
    let ints = req.body.intents;
